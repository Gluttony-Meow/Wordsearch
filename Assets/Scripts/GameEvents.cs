...
public static class GameEvent
{
    ...
    public delegate void CorrectWord(string word, List<int> squareIndexas);
    public static event CorrectWord OnCorrectWord;

    public static void CorrectWordMethod(string word, List<int> squareIndexas)
    {
        if (OnCorrectWord != null)
        {
            OnCorrectWord(word, squareIndexas);
        }
    }
